...
$(document).keypress(function(e) {
    ...
    let keyStroke = e.which;
        ...
        function gameOver() {
            ...
            console.log(wpm);
            promptContainer.css('font-family', 'cursive');
            let tryAgain = promptContainer.text("You type " + wpm + " words per minute. You made " + errorCount + " mistakes. Would you like to try again? If YES, press F5. If NO, then GET OUTTA HEREE!!");
            let tryAgainButton = $('<input type="submit" id="try-again" value="Try Again!" style="border-radius: 5px;"></input>');
            promptContainer.append(tryAgainButton);
            tryAgainButton.click(function(e) {
                location.reload();
            });
